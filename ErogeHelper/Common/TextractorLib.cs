...
using static ErogeHelper.Common.TextractorLib.TextHostLib;

namespace ErogeHelper.Common
{
    static class TextractorLib
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(TextractorLib));
        ...
        static public void OutputHandle(long threadid, string opdata)
        {
            ...
            DataEvent?.Invoke(typeof(TextractorLib), hp);
